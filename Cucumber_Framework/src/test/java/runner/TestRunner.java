...
@CucumberOptions(
	...
	/*
	//This is for reporting using cucumber and rerun plugin is used for storing failed scenarios in text file and we will rerun using rerunner class 
	plugin= {"rerun:target/failed_scenarios.txt",       // this plugin is used to rerun the failed scenarios
//			"pretty",									// this will simply print in console
			"usage",									// used for duration of execution
			"html:target/cucumber-reports/report.html", //html report generaion 
			"json:target/cucumber-reports/report.json", //json report generaion
			"junit:target/cucumber-reports/report.xml"  //xml report generaion
			}
	*/ 
